...
const recurringEvents: Event[] = [
  ...
  {
    id: "priere-et-temoignages",
    slug: "priere-et-temoignages",
...
export const specialEvents: SpecialEvent[] = [
  ...
  },
  {
    ...
    slug: "seminaire-trois-jours-novembre",
    title: "Séminaire Trois jours de gloire",
    description:
      "Trois jours d'enseignement, de prière et de communion pour toute l'église.",
    body: "Un temps fort de trois jours : enseignement le matin, ateliers l'après-midi, et un temps d'autel chaque soir.\n\nL'inscription est demandée pour préparer l'accueil et les supports.",
    startsAt: "2026-11-10T09:00:00",
    endsAt: "2026-11-12T16:00:00",
    location: venue,
    kind: "seminaire",
    registrationRequired: true,
    isFeatured: true,
